yconst fs = require('fs-extra') 
 if (fs.existsSync('config.env')) require('dotenv').config({ path: __dirname+'/config.env' }) 
  
  
 //═══════[Required Variables]════════\\ 
 global.owner = process.env.OWNER_NUMBER.split('71 937 0832','71 937 0832') 
 ...
 module.exports = { 
   botname:   process.env.BOT_NAME === undefined ? 'mr nadil' : process.env.BOT_NAME, 
   ownername: process.env.OWNER_NAME === undefined ? 'mr nadil' : process.env.OWNER_NAME,  
